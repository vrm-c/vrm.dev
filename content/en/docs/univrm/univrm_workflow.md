...
You can manually change the model pose to [T-Pose](../../docs/dev/univrm-0.xx/vrm/vrm_tpose/) (done automatically by default). Make sure to deselect the `Force T Pose` checkbox.
