...
Download VRM Viewer from [UniVRMTest/releases](https://github.com/vrm-c/UniVRMTest/releases). Next, run the program and click``VRM Model``. Select a VRM model available on your computer. The VRM model can be shown in the scene. Other VRM viewers [can be found here]({{< relref "vrm_applications.md#viewer" >}}).
